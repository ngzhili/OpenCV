...
## Description
This application do not require any prior installation of python to run. 

## Installation
Download the folder and extract all contents. Double click on coco_viewer application to run.


## Usage

On the main application interface:
- Select Raw Image folder directory that contains annotated images
...
## License
[MIT](ngzhili/OpenCV/LICENSE)


## Authors and acknowledgment:
- pycocotools API was used in this project


________________________________________________________________________________________________________
Application made by Ng Zhili
